...
void umain(int argc, char **argv) {
    if (argc == 1) {
        ...
        if (strcmp(argv[1], "-r") == 0) {
            declare(argv[2], "NULL", 1, 1);
        } else if (strcmp(argv[1], "-x") == 0) {
            declare(argv[2], "NULL", 0, 0);
        } else if (strcmp(argv[1], "-xr") == 0 || strcmp(argv[1], "-rx") == 0) {
            declare(argv[2], "NULL", 0, 1);
        } else {
        ...
        if (strcmp(argv[1], "-xr") == 0 || strcmp(argv[1], "-rx") == 0) {
            declare(argv[2], argv[3] + 1, 0, 1);
        } else if (strcmp(argv[1], "-r") == 0) {
            declare(argv[2], argv[3] + 1, 1, 1);
        } else if (strcmp(argv[1], "-x") == 0) {
            declare(argv[2], argv[3] + 1, 0, 0);
        }
    }
    writef("finish declare " GREEN(%s)"\n", argv[2]);
    return;
